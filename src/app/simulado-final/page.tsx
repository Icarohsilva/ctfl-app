    ...
    return (
      <main style={{ background: "#0b0f1a", minHeight: "100vh", color: "#e5e7eb", fontFamily: "sans-serif" }}>
        <div style={{ maxWidth: "700px", margin: "0 auto", padding: "2rem 1.5rem" }}>
          ...
          {aprovado ? (
            <>
              <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://testpath.online")}`}
                target="_blank" rel="noopener noreferrer"
                style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", width: "100%", background: "#0a66c2", borderRadius: "10px", padding: "14px", color: "#ffffff", fontSize: "15px", fontWeight: "600", textDecoration: "none", boxSizing: "border-box", marginBottom: "10px", boxShadow: "0 0 0 1px rgba(10,102,194,0.4), 0 8px 24px rgba(10,102,194,0.18)" }}>
